      ...
      <div className="w-full lg:w-3/5 bg-white dark:bg-black dark:text-white p-8 relative">
        <div className="max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-5">
              <Label htmlFor="name"  className="text-sm text-gray-600 dark:text-white">
                Name*
              </Label>
              <Input
                type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
              <div>
                <Label htmlFor="phone"  className="text-sm text-gray-600 dark:text-white">
                  Phone*
                </Label>
                <Input
                  type="tel"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
              <div>
                <Label htmlFor="industry"  className="text-sm text-gray-600 dark:text-white">
                  Industry*
                </Label>
                <Select onValueChange={(value) => handleSelectChange("industry", value)} value={formData.industry}>
                  <SelectTrigger className="border-gray-300 dark:border-zinc-700">
              ...
              <div>
                <Label htmlFor="budget" className="text-sm text-gray-600 dark:text-white">
                  Expected Budget*
                </Label>
            ...
            <div className="mb-5">
              <Label htmlFor="message"  className="text-sm text-gray-600 dark:text-white">
                Message*
              </Label>
              <Textarea
                id="message"
                ...
                onChange={handleChange}
                required
                className="min-h-[100px] border-gray-300 dark:border-zinc-700"
              />
            </div>
