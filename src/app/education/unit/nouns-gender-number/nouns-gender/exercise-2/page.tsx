    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-6 md:mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Exercise 2: Masculine to Feminine Conversion</h1>
          <p className="text-base md:text-lg text-gray-600">Convert each masculine noun to its feminine form</p>
        </div>
        ...
        <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-blue-800 mb-1">Exercise Description</h3>
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex-1">
                      <div className="font-semibold text-gray-800 mb-1">{pair.masculine}</div>
                      <div className="text-sm text-gray-500">→ Feminine form</div>
                    </div>
                    <div className="flex-1">
                      <input
                        type="text"
