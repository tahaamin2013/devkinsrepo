...
type NounRow = {
  ...
  pluralWord: string;
  pluralMeaning1: string;
  pluralMeaning2: string;
};
...
const nouns: NounRow[] = [
  {
    ...
    pluralWord: "colours",
    pluralMeaning1: "hues.",
    pluralMeaning2: "the flag of a regiment.",
  },
  {
    singular: "Custom",
    singularMeaning: "habit.",
    pluralWord: "customs",
    pluralMeaning1: "habits.",
    pluralMeaning2: "duties levied on imports.",
  },
  {
    singular: "Effect",
    singularMeaning: "result.",
    pluralWord: "effects",
    pluralMeaning1: "results.",
    pluralMeaning2: "property.",
  },
  {
    singular: "Manner",
    singularMeaning: "method.",
    pluralWord: "manners",
    pluralMeaning1: "methods.",
    pluralMeaning2: "correct behaviour.",
  },
  {
    singular: "Moral",
    singularMeaning: "a moral lesson.",
    pluralWord: "morals",
    pluralMeaning1: "moral lessons.",
    pluralMeaning2: "conduct.",
  },
  {
    singular: "Number",
    singularMeaning: "a quantity.",
    pluralWord: "numbers",
    pluralMeaning1: "quantities.",
    pluralMeaning2: "verses.",
  },
  {
    singular: "Pain",
    singularMeaning: "suffering.",
    pluralWord: "pains",
    pluralMeaning1: "sufferings.",
    pluralMeaning2: "care, exertion.",
  },
  {
    singular: "Premise",
    singularMeaning: "proposition.",
    pluralWord: "premises",
    pluralMeaning1: "propositions.",
    pluralMeaning2: "buildings.",
  },
  {
    singular: "Quarter",
    singularMeaning: "fourth part.",
    pluralWord: "quarters",
    pluralMeaning1: "fourth parts.",
    pluralMeaning2: "lodgings.",
  },
  {
    singular: "Spectacle",
    singularMeaning: "a sight.",
    pluralWord: "spectacles",
    pluralMeaning1: "sights.",
    pluralMeaning2: "eye-glasses.",
  },
  {
    singular: "Letter",
    singularMeaning: "letter of alphabet; epistle.",
    pluralWord: "letters",
    pluralMeaning1: "letters of alphabet.",
    pluralMeaning2: "epistles.",
  },
  {
    singular: "Ground",
    singularMeaning: "earth; reason.",
    pluralWord: "grounds",
    pluralMeaning1: "enclosed land attached to a house; reasons.",
    pluralMeaning2: "dregs.",
  },
];
...
export default function NounsPage6d() {
    ...
    <div className="min-h-screen transition-colors duration-300 bg-white dark:bg-[#1C1917] font-sans">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/[0.03] px-5 py-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-800 dark:text-white">Rule 6d</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
              Some nouns have{" "}
              <span className="font-semibold text-gray-700 dark:text-gray-200">one meaning in the singular</span>{" "}
              but{" "}
              <span className="font-semibold text-gray-700 dark:text-gray-200">two meanings in the plural</span>.
        ...
        {allCorrect && (
          ...
          >
            ...
            <p className="text-sm font-semibold text-green-700 dark:text-green-300">
              All correct! You have mastered all Rule 6d nouns.
            </p>
          </div>
        )}
        ...
        >
          ...
          <div className="bg-[#1C1917] dark:bg-white/8 px-6 py-5 flex items-center gap-4 border-b border-white/10">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-xl font-bold text-white tracking-tight">One Singular Meaning, Two Plural Meanings</h2>
          ...
          <div className="divide-y divide-gray-100 dark:divide-white/6 bg-white dark:bg-[#1C1917]">
            {nouns.map(({ singular, singularMeaning, pluralWord, pluralMeaning1, pluralMeaning2 }) => {
              ...
              return (
                <div key={singular} className="grid grid-cols-2 hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                  ...
                  {/* ── Col 1: Singular word + one meaning ── */}
                  <div className="px-4 py-4 flex flex-col justify-center gap-1.5">
                    ...
                    <p className="text-[12px] text-gray-500 dark:text-gray-400 leading-snug italic">
                      {singularMeaning}
                    </p>
                  </div>

                  {/* ── Col 2: Two plural meanings + input field ── */}
                  <div className="px-4 py-4 border-l border-gray-100 dark:border-white/6 flex flex-col justify-center gap-2">
                    ...
                    <div className="relative mt-0.5">
                      ...
                      <span className="font-semibold text-blue-600 dark:text-blue-400">(meaning 1:</span>{" "}
                      <span className="italic">{pluralMeaning1}</span>
                      <span className="font-semibold text-blue-600 dark:text-blue-400">)</span>
                    </p>
                    {/* Meaning 2 */}
                    <p className="text-[12px] leading-snug text-gray-500 dark:text-gray-400">
                      <span className="font-semibold text-purple-600 dark:text-purple-400">(meaning 2:</span>{" "}
                      <span className="italic">{pluralMeaning2}</span>
