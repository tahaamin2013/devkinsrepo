...
const categories: Category[] = [
  {
    ...
    icon: "💭",
    words: [
      { word: "hope", note: "usually no plural (uncountable)" },
      { word: "charity", note: "usually no plural (uncountable)" },
      { word: "love", note: "usually no plural (uncountable)" },
      { word: "kindness", note: "kindnesses = acts of kindness" },
    ],
  },

  {
    ...
    icon: "🔧",
    words: [
      { word: "copper", note: "coppers = copper coins" },
      { word: "iron", note: "irons = fetters/chains" },
      { word: "tin", note: "tins = cans made of tin" },
      { word: "wood", note: "woods = forests" },
    ],
  },
...
export default function NounsPage() {
  ...
  function dropdownStatus(word: string, idx: number): "empty" | "correct" | "wrong" {
    ...
    if (!val) return "empty";
    return val === "no_plural" ? "correct" : "wrong";
  }
