...
const ALL_QUESTIONS: MCQQuestion[] = [
  ...
  { id: '8', category: 'Instruments with two parts', question: 'What is the singular of "scissors"?', options: ['scissor', 'scissorses', 'scissorens', 'scissors'], answer: 'scissors', explanation: 'Scissors is always used in plural form because it has two blades.' },
  { id: '9', category: 'Instruments with two parts', question: 'What is the singular of "spectacles" (glasses)?', options: ['spectacle', 'spectacless', 'spectaclies', 'spectacles'], answer: 'spectacles', explanation: 'Spectacles always stays plural as it refers to a pair of lenses.' },
  { id: '10', category: 'Instruments with two parts', question: 'What is the singular of "binoculars"?', options: ['binocular', 'binocularses', 'binocularies', 'binoculars'], answer: 'binoculars', explanation: 'Binoculars is always used in its plural form.' },
  { id: '11', category: 'Instruments with two parts', question: 'What is the singular of "tongs"?', options: ['tong', 'tonges', 'tongies', 'tongs'], answer: 'tongs', explanation: 'Tongs is always used in plural form because it has two arms.' },
