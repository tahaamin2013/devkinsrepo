...
const practice: PracticeRow[] = [
  { sentence: "Rama gave Hari a ball.", question: "What did Rama give?", answer: "A ball" },
  { sentence: "Will you do me a favour?", question: "What will you do?", answer: "A favour" },
  { sentence: "I bought Rama a ball.", question: "What did I buy?", answer: "A ball" },
  { sentence: "Fetch the boy a book.", question: "What should you fetch?", answer: "A book" },
  { sentence: "She made Ruth a new dress.", question: "What did she make?", answer: "A new dress" },
  { sentence: "Get me a taxi.", question: "What should you get?", answer: "A taxi" },
];
...
export default function ObjectiveCaseExercise3Page() {
        ...
        <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/[0.03] px-5 py-4 flex items-start gap-3">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Ask <span className="font-semibold text-gray-700 dark:text-gray-300">Whom?</span> or{" "}
              <span className="font-semibold text-gray-700 dark:text-gray-300">What?</span> before the verb and its
              subject to find the noun (or pronoun) in the Objective Case.
            </p>
          </div>
        </div>
        ...
        >
          <div className="bg-[#1C1917] dark:bg-white/8 px-6 py-5 flex items-center gap-4 border-b border-white/10">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-xl font-bold text-white tracking-tight">Find the Objective Case</h2>
              <p className="text-gray-400 text-sm mt-0.5">
                Ask Whom? or What? before the verb, then type the noun/pronoun in the Objective Case
              </p>
            </div>
          ...
          <div className="px-5 py-3.5 bg-gray-50 dark:bg-white/[0.02] border-t border-gray-200 dark:border-white/8 flex items-center justify-between gap-4 flex-wrap">
            <p className="text-xs text-gray-500 leading-relaxed">
              ...
              These sentences have two objects — focus on the Direct Object (the thing given, made, or fetched).
            </p>
            <button
