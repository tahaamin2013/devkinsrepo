...
const examples: Example[] = [
  { sentence: "The police arrested the thief.", question: "Whom did the police arrest?", objective: "The thief" },
  { sentence: "He bought a digital watch.", question: "What did he buy?", objective: "A digital watch" },
];
...
const practice: PracticeRow[] = [
  { sentence: "The dog ran across the road.", question: "What did the dog run across?", answer: "The road" },
  { sentence: "He arrived before me.", question: "Whom did he arrive before?", answer: "Me" },
  { sentence: "The dog bit the monkey.", question: "Whom did the dog bite?", answer: "The monkey" },
  { sentence: "The monkey bit the dog.", question: "Whom did the monkey bite?", answer: "The dog" },
  { sentence: "He struck me.", question: "Whom did he strike?", answer: "Me" },
  { sentence: "I struck him.", question: "Whom did I strike?", answer: "Him" },
  { sentence: "He sells vases.", question: "What does he sell?", answer: "Vases" },
  { sentence: "The mongoose eats snakes.", question: "What does the mongoose eat?", answer: "Snakes" },
  { sentence: "Snakes fear the mongoose.", question: "Whom do snakes fear?", answer: "The mongoose" },
  { sentence: "Mosquitoes cause malaria.", question: "What do mosquitoes cause?", answer: "Malaria" },
  { sentence: "She was playing with the children.", question: "Whom was she playing with?", answer: "The children" },
  { sentence: "They are very proud of her.", question: "Whom are they proud of?", answer: "Her" },
  { sentence: "The result was announced by the teacher.", question: "By whom was the result announced?", answer: "The teacher" },
  { sentence: "John threw a stone.", question: "What did John throw?", answer: "A stone" },
  { sentence: "The horse kicked the boy.", question: "Whom did the horse kick?", answer: "The boy" },
  { sentence: "The book is on the desk.", question: "What is the book on?", answer: "The desk" },
  { sentence: "Hari broke the window.", question: "What did Hari break?", answer: "The window" },
];
...
export default function ObjectiveCasePage() {
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/[0.03] px-5 py-4 flex items-start gap-3">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <span className="font-semibold text-gray-700 dark:text-gray-300">Objective (or Accusative) Case</span>.
              A noun which comes after a preposition is also said to be in the Accusative Case.
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              To find the Objective, put <span className="font-semibold text-gray-700 dark:text-gray-300">Whom?</span> or{" "}
              <span className="font-semibold text-gray-700 dark:text-gray-300">What?</span> before the verb and its
              subject. The answer will be the objective. The Nominative generally comes before the verb, and the
              Objective after it.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl overflow-hidden border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-2xl">
          <div className="bg-[#1C1917] dark:bg-white/8 px-6 py-5 flex items-center gap-4 border-b border-white/10">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-400 text-sm mt-0.5">See how Whom? / What? finds the objective</p>
            </div>
          </div>
          ...
          <div className="divide-y divide-gray-100 dark:divide-white/6 bg-white dark:bg-[#1C1917]">
            {examples.map((ex, i) => (
              <div key={i} className="grid grid-cols-3 hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                ...
                <div className="px-4 py-3.5 border-l border-gray-100 dark:border-white/6 flex items-center">
                  <span className="text-sm font-semibold text-green-700 dark:text-green-300">{ex.objective}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        {allCorrect && (
          ...
          >
            ...
            <p className="text-sm font-semibold text-green-700 dark:text-green-300">
              All correct! You have found the objective in every sentence.
            </p>
          </div>
        )}
        ...
        >
          <div className="bg-[#1C1917] dark:bg-white/8 px-6 py-5 flex items-center gap-4 border-b border-white/10">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-xl font-bold text-white tracking-tight">Find the Objective</h2>
              <p className="text-gray-400 text-sm mt-0.5">
                Ask Whom? or What? before the verb, then type the objective
              </p>
            </div>
          ...
          <div className="px-5 py-3.5 bg-gray-50 dark:bg-white/[0.02] border-t border-gray-200 dark:border-white/8 flex items-center justify-between gap-4 flex-wrap">
            <p className="text-xs text-gray-500 leading-relaxed">
              ...
              Find the verb first, then ask Whom? or What? before it — include any descriptive words that belong with
              the object (e.g. "The mongoose", not just "mongoose").
            </p>
            <button
