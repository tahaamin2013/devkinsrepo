...
export default function ExamplePage() {
    return (
        <ServiceComponent
            ...
            serviceDescription="Our mobile Design services cover the entire app lifecycle, from concept and design to Design, deployment, and ongoing support. We leverage the latest technologies to deliver robust, user-friendly mobile applications that help you engage your audience and grow your business."
            ...
            benefits={[
                ...
                },
                {
                    ...
                    description:
                        "Accelerate your app launch with efficient Design processes and proven frameworks.",
                },
                {
